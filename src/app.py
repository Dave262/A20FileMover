...
from controllers.macos_drive_controller import UsbDeviceHandler
...
class App(ctk.CTk):
    def __init__(self):
        ...
        self._usb_controller = UsbDeviceHandler()
        self._drive = ()
...
# Manually select path to A20 mount
        ...
        self.A20_textbox = ctk.CTkTextbox(self.frame_left, height=300)
...
# Progress bar
    ...
    def update_drives(self, tx_info=None):
        ...
        for drive_info in tx_info:
            ...
            # Create a new button
            button = ctk.CTkButton(self.frame_left, text=f"TX: {drive_name}", command=lambda dn=device_node: self.handle_drive_selection(dn))
